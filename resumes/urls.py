...
urlpatterns = [
    ...
    path('user/dashboard/', views.get_candidate_dashboard_view, name='candidate_dashboard_api'),
    path('recruiter/dashboard/', views.get_recruiter_dashboard_view, name='recruiter_dashboard_api'),
    ...
    path('refactor-bullets/', views.refactor_bullets_view, name='refactor_bullets_api'),
