                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 mt-1">
                                                    PDF, DOCX, or TXT ΓÇó MAX 10 FILES
                                                </p>
                                            </div>
                                            {files.length > 0 && (
                                                ...
                                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                                    <div className="flex items-center gap-6">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex items-center gap-2 mt-1">
                                                                <span className="text-[10px] text-white/30 font-bold uppercase tracking-widest">{cand.experience}yr+ Exp</span>
                                                                <span className="text-[10px] text-indigo-400 font-black uppercase tracking-widest">{cand.confidence} Confidence</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
export default BulkScannerPublic;
